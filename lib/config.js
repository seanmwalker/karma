...
var Pattern = function(pattern, served, included, watched, insertBeforeFramework) {
  this.pattern = pattern;
  this.served = helper.isDefined(served) ? served : true;
  this.included = helper.isDefined(included) ? included : true;
  this.watched = helper.isDefined(watched) ? watched : true;
  this.included = helper.isDefined(insertBeforeFramework) ? insertBeforeFramework : false;
};
...
var createPatternObject = function(pattern) {
  ...
  if (helper.isObject(pattern)) {
    ...
    return helper.isUrlAbsolute(pattern.pattern) ?
        ...
        new Pattern(pattern.pattern, pattern.served, pattern.included, pattern.watched, pattern.insertBeforeFramework);
  }
